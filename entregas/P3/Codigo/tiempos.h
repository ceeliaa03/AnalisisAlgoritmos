...
typedef struct tiempo {
  ...
  int medio_ob; /* numero premedio de veces que se ejecuta la OB */
...
/* Funciones */
short tiempo_medio_ordenacion(pfunc_ordena metodo, int n_perms,int tamanio, PTIEMPO ptiempo, int pivote);
...
short genera_tiempos_ordenacion(pfunc_ordena metodo, char* fichero, int num_min, int num_max, int incr, int n_perms, int pivote);
